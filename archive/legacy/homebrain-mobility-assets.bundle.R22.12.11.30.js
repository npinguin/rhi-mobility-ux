/**
 * Home Intelligence Mobility bundle.
 * GENERATED FILE - DO NOT EDIT DIRECTLY.
 * Source: source/src/*.js
 */
 ...
 * Release: R22.12.11.30_R43_2_54_CHARGER_CONTRACT_MATERIALIZATION_CLOSURE
 *
 * Purpose:
 ...
 * - Command placement comes from command-slot contracts; readiness/execution metadata comes from sensor.mobility_command_index; execution uses the canonical Mobility command ingress.
 *
 ...
 * - Keeps bundle-only deployment: /local/homebrain/cards/homebrain-mobility-assets.bundle.js?v=R22.12.11.30
 */
/*
Home Intelligence Mobility Assets Bundle vR22.12.11.30
...
class HomeBrainAssetRuntime {
  ...
  imageCatalog() {
    ...
    return [
      { image_key:"vehicle_audi_q8", package_file:"/local/homebrain/mobility/vehicles/vehicle_audi_q8.png", fallback_image_key:"vehicle_fallback" },
      { image_key:"vehicle_audi_q8_hero", package_file:"/local/homebrain/mobility/vehicles/vehicle_audi_q8_hero.png", fallback_image_key:"vehicle_audi_q8" },
      { image_key:"vehicle_mercedes_gla", package_file:"/local/homebrain/mobility/vehicles/vehicle_mercedes_gla.png", fallback_image_key:"vehicle_fallback" },
      { image_key:"vehicle_vw_id4", package_file:"/local/homebrain/mobility/vehicles/vehicle_vw_id4.png", fallback_image_key:"vehicle_fallback" },
      { image_key:"vehicle_bmw_ix1_phev", package_file:"/local/homebrain/mobility/vehicles/vehicle_bmw_ix1_phev.png", fallback_image_key:"vehicle_unknown_profile" },
      { image_key:"vehicle_bmw_x1", package_file:"/local/homebrain/mobility/vehicles/vehicle_bmw_ix1_phev.png", fallback_image_key:"vehicle_unknown_profile" },
      { image_key:"vehicle_bmw_ix1_phev_hero", package_file:"/local/homebrain/mobility/vehicles/vehicle_bmw_ix1_phev_hero.png", fallback_image_key:"vehicle_bmw_ix1_phev" },
      { image_key:"vehicle_renault_scenic_techno_ev", package_file:"/local/homebrain/mobility/vehicles/vehicle_renault_scenic_techno_ev.png", fallback_image_key:"vehicle_unknown_profile" },
      { image_key:"vehicle_renault_scenic", package_file:"/local/homebrain/mobility/vehicles/vehicle_renault_scenic_techno_ev.png", fallback_image_key:"vehicle_unknown_profile" },
      { image_key:"vehicle_renault_scenic_techno_ev_hero", package_file:"/local/homebrain/mobility/vehicles/vehicle_renault_scenic_techno_ev_hero.png", fallback_image_key:"vehicle_renault_scenic_techno_ev" },
      { image_key:"vehicle_unknown_profile", package_file:"/local/homebrain/mobility/vehicles/vehicle_unknown_profile.png", fallback_image_key:"vehicle_fallback" },
      { image_key:"vehicle_unknown_profile_hero", package_file:"/local/homebrain/mobility/vehicles/vehicle_unknown_profile_hero.png", fallback_image_key:"vehicle_unknown_profile" },
      { image_key:"vehicle_guest", package_file:"/local/homebrain/mobility/vehicles/vehicle_unknown_profile.png", fallback_image_key:"vehicle_unknown_profile" },
      { image_key:"vehicle_guest_generic", package_file:"/local/homebrain/mobility/vehicles/vehicle_unknown_profile.png", fallback_image_key:"vehicle_unknown_profile" },
      { image_key:"vehicle_fallback", package_file:"/local/homebrain/mobility/vehicles/vehicle_fallback.png", fallback_image_key:"vehicle_fallback" },
      { image_key:"charger_wallbox", package_file:"/local/homebrain/mobility/chargers/charger_wallbox.png", fallback_image_key:"charger_fallback" },
      { image_key:"charger_wallbox_white", package_file:"/local/homebrain/mobility/chargers/charger_wallbox_white.png", fallback_image_key:"charger_wallbox" },
      { image_key:"charger_wallbox_black", package_file:"/local/homebrain/mobility/chargers/charger_wallbox_black.png", fallback_image_key:"charger_wallbox" },
      { image_key:"charger_peblar", package_file:"/local/homebrain/mobility/chargers/charger_peblar.png", fallback_image_key:"charger_fallback" },
      { image_key:"charger_utility_plug", package_file:"/local/homebrain/mobility/chargers/charger_utility_plug.png", fallback_image_key:"charger_fallback" },
      { image_key:"charger_fallback", package_file:"/local/homebrain/mobility/chargers/charger_fallback.png", fallback_image_key:"charger_fallback" }
    ];
  }
...
class HomeBrainVehicleAdapter {
  ...
  build() {
    ...
    return {
      ...
      image:this.rt.cache(img), fallbackImage:this.rt.cache(`${this.config.image_base || "/local/homebrain/mobility/vehicles"}/vehicle_fallback.png`), imageOpacity:present ? 1 : 0.34, imageGray:present ? 0 : 0.25,
      chargerImage:this.rt.cache(this.chargerImage(chargerContextId)), chargerFallbackImage:this.rt.cache(`/local/homebrain/mobility/chargers/charger_fallback.png`),
...
class HomeBrainChargerAdapter {
  ...
  build() {
    ...
    return {
      ...
      image:this.rt.cache(this.chargerImageFromId()), fallbackImage:this.rt.cache(`${this.config.image_base || "/local/homebrain/mobility/chargers"}/charger_fallback.png`), imageOpacity:available ? 1 : 0.34, imageGray:available ? 0 : 0.25,
...
class HomeBrainVehicleAssetDetailCard extends HTMLElement {
  setConfig(config) {
    this.config = {
      ...
      fallback_image: "/local/homebrain/mobility/vehicles/default_vehicle.png",
      image_base: "/local/homebrain/mobility/vehicles",
...
class HomeBrainChargerAssetDetailCard extends HTMLElement {
  setConfig(config) {
    this.config = {
      ...
      image_base: "/local/homebrain/mobility/chargers",
      dashboard_path: "/mobility-supervisor/dashboard",
      resource_version: UX_VERSION,
      ...config
    };
...
class HomeBrainMobilityChargerMaintenanceCard extends HTMLElement {
  ...
  chargerImageFromId(id) {
    const base = this.config.image_base || "/local/homebrain/mobility/chargers";
    ...
    const asset = rt ? rt.chargerById(assetId) : null;
    const key = asset?.image_key || asset?.raw?.image_key || asset?.fallback_image_key || asset?.raw?.fallback_image_key || "default_charger";
    return `${base}/${String(key).toLowerCase().replace(/[^a-z0-9_\-]/g, "_")}.png?v=${UX_VERSION}`;
  }
      ...
      <section class="fold-section ${maintenanceOpen ? "open" : ""}" data-panel-key="${rt.escape(`${assetId}:maintenance`)}">
        ...
        <div class="fold-panel">
          <div class="detail-grid">
            ...
            ${this.detailField(rt, "Command readiness", "sensor.mobility_command_index")}
          </div>
        </div>
      </section>
  ...
  set hass(hass) {
    ...
    this.shadowRoot.innerHTML = `<ha-card>
      <div class="page">
        ...
        <section class="title ops-title"><p class="eyebrow">HOME INTELLIGENCE / MOBILITY</p><h1>Mobility</h1><p>Vehicle readiness, charging, comfort and security in one calm control cockpit.</p></section>
        ${hbMobilityNav("chargers")}
...
class HomeBrainMobilityDashboardCard extends HTMLElement {
  ...
  chargerImage(assetOrId) {
    ...
    return `/local/homebrain/mobility/chargers/charger_fallback.png?v=${UX_VERSION}`;
  }
