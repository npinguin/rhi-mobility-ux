...
if(!release.includes('git show "${TAG}:dist/rhi-mobility-ux.js"')) throw new Error('stable flow does not verify immutable tag runtime payload');
...
console.log('PASS immutable candidate qualification lifecycle regression');
