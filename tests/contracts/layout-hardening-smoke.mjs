...
if(!header.includes('rhiMobilityAssetUrl(HB_MOBILITY_COMPANY_LOGO)')) throw new Error('header does not resolve canonical shared logo through HACS asset resolver');
