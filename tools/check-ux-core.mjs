...
if(meta.version!=="1.3.1" || meta.source_commit!=="13fc1e1b07f3fcfe9aac960471b74cfd0e96a8b9") throw new Error("unexpected RHI UX Core pin");
...
console.log("PASS Mobility consumes pinned RHI UX Core 1.3.1 including canonical company branding without runtime coupling or duplicate shell");
