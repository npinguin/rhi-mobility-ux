...
for(const [key,value] of Object.entries(q)) {
  if(key==='candidate_version' || key==='stable_promotion') continue;
...
if(requirePass) {
  const pending=Object.entries(q).filter(([key,value])=>key!=='candidate_version' && key!=='stable_promotion' && value!=='pass');
