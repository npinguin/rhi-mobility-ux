/**
 * Robotix Home Intelligence Mobility UX v1.0.0-rc.36
    ...
    this.shadowRoot.innerHTML = `<ha-card>
      <div class="page">
        ...
        ${hbMobilityPageHero(rt, "chargers", {
          meta:`<strong>${activeChargers.length} active</strong><span>${operational} operational · ${totalPower.toFixed(1)} kW now</span>`
        })}
