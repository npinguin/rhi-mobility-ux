...
Charging remains a Mobility capability. They are not a standalone Mobility workspace. Planning is presented under Mobility Intelligence, but planning semantics, schedules and totals are owned by the Energy backend and consumed through its public UX contracts.
...
- Mobility provides vehicle/charger execution, readiness, commands and operational/audit evidence.
