...
The current source candidate is `v1.0.0-rc.10`. It preserves all existing Mobility routes and screens while aligning the shared shell with Energy: identical header proportions and hierarchy, the same canonical transparent Robotix company mark, compact gray icons on the secondary navigation, and responsive brand-slot behaviour.
