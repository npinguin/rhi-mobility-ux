...
The current source candidate is `v1.0.0-rc.9`. It preserves the rc.8 routes and screens while hardening the shared Mobility shell: official HACS-root Robotix branding, horizontal status/outcome rails, and consistent header proportions.
